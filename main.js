window.addEventListener('load', () => {
    ...
    form.addEventListener('submit', (e) => {
        ...
        // Add event listeners to the buttons for the newly added task
    ...
    function updateLocalStorage() {
        ...
        tasksElements.forEach(taskElement => {
            ...
            tasks.push({ name: taskText, completed: isCompleted });
        });
    ...
    function loadTasksFromLocalStorage() {
        ...
        if (tasks && tasks.length > 0) {
            tasks.forEach(taskObj => {
                ...
                task_input_el.classList.add("text");
                task_input_el.type = "text";
                task_input_el.value = taskObj.name;
                task_input_el.setAttribute("readonly", "readonly");
                ...
                // Add event listeners to the buttons for the loaded tasks
                task_edit_el.addEventListener('click', () => {
                    if (task_edit_el.innerText.toLowerCase() === "edit") {
                        task_input_el.removeAttribute("readonly");
                        task_input_el.focus();
